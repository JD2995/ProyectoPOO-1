...
public class Revista extends Articulo{
	...
	/*Descripción: Función que devuelve en los atributos de la clase los datos de una revista
	...
	public boolean Obtener(int num,String name){
		...
		File archivo= null;
		FileReader fr;
		//Si existe el número de revista
		...
		try{
			...
			while(cant_chars!= -1){
				...
				//Si encontró el número de revista registrado
				if(i == num){
					String palabra= "";
					i=0;
					while(i!=6){
				...
				//Si encontró el separador entre revistas
				if((char)Buffer[j] == ','){
					i++;	//Aumenta el número de revistas encontradas
				}
